...
export default function ServicesPage() {
  ...
  return (
    <>
      <div className={`services-page ${isBookingOpen ? 'services-page--darkened' : ''}`}>
              ...
              <article key={service.id} className="services-page__service">
                <div className="services-page__service-container">
                  ...
                  <div className="services-page__right-side">
                    <div>
                      <p className="services-page__price">{`${service.priceRange} PLN`}</p>
                      <p className='services-page__time'>{convertTime(service.duration)}</p>
                    </div>
                    <div>
                      <button
                        onClick={() => {
