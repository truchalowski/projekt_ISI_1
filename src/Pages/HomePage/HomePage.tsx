  ...
  return (
    <div className="homepage">
      <div className="homepage__text">
        ...
        <Link to={user ? 'services' : 'login'} className="homepage__btn">
          Book
        </Link>
      </div>
      <Swiper
      ...
      >
        <SwiperSlide className="homepage__slide">
          <img
            loading="eager"
            src="blonde-girl-getting-her-hair-done.jpg"
        ...
        <SwiperSlide className="homepage__slide">
          <img
            loading="eager"
            src="hairdresser-taking-care-her-client.jpg"
        ...
        <SwiperSlide className="homepage__slide">
          <img
            loading="eager"
            src="woman-getting-her-hair-cut-beauty-salon.jpg"
